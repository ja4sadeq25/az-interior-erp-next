...
const NAV: { href: string; key: "dashboard" | "projects" | "site" | "procurement" | "inventory" | "billing" | "documents" | "users" | "audit"; roles: Role[] }[] = [
  { href: "/", key: "dashboard", roles: ["master", "admin", "architect", "3d_artist", "project_manager", "site_engineer", "procurement", "finance"] },
  { href: "/projects", key: "projects", roles: ["master", "admin", "architect", "3d_artist", "project_manager", "site_engineer", "procurement", "finance", "client"] },
  { href: "/site", key: "site", roles: ["master", "admin", "architect", "3d_artist", "project_manager", "site_engineer"] },
  { href: "/procurement", key: "procurement", roles: ["master", "admin", "architect", "3d_artist", "procurement", "project_manager", "finance"] },
  { href: "/inventory", key: "inventory", roles: ["master", "admin", "architect", "3d_artist", "procurement", "project_manager", "site_engineer"] },
  { href: "/billing", key: "billing", roles: ["master", "admin", "finance"] },
  { href: "/documents", key: "documents", roles: ["master", "admin", "architect", "3d_artist", "project_manager", "site_engineer", "procurement", "finance"] },
