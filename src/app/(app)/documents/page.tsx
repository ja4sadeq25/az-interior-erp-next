...
export default async function DocumentsPage() {
  ...
  const canUpload = ["master", "admin", "architect", "3d_artist", "project_manager", "site_engineer"].includes(profile.role);
  const canManage = ["master", "admin", "architect", "3d_artist", "project_manager"].includes(profile.role);
